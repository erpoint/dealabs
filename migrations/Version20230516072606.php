...
final class Version20230516072606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE deal (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, link VARCHAR(255) DEFAULT NULL, full_price DOUBLE PRECISION NOT NULL, current_price DOUBLE PRECISION NOT NULL, degres INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1024) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', image VARCHAR(255) NOT NULL, INDEX IDX_E3FEC1167E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
